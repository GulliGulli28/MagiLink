...
window.onload = () => {
  var tab = [0, 0, 0, 0, 0, 0];
  var titres = [
    "Which animal do you bring to Hogwarts?",
    "Which Magic do you prefer?",
    "Which drink to drink at a party?",
    "Who is your favorite teacher?",
    "In a team what is your mindset",
  ];
  ...
  var images_rep_l_2 = [
    "../assets/rat.jpg",
    "../assets/wingardiumleviosa2.png",
    "../assets/butterbeer.png",
    "../assets/snape.jpg",
    "",
  ];
  var images_rep_r_1 = [
    "../assets/toad2.jpg",
    "../assets/expeliarmus.jpg",
    "../assets/whiskey.jpg",
    "../assets/gonagall.jpg",
    "",
  ];
  var images_rep_r_2 = [
    "../assets/owl.jpg",
    "../assets/alohomora.jpg",
    "../assets/pumpkinjuice.jpg",
    "../assets/hagrid.jpg",
    "",
  ];
  var nb_question = 1;
